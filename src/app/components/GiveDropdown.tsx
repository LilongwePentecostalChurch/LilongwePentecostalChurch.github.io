...
import { HandCoins, Quote } from 'lucide-react';
...
const menuItems: MenuItem[] = [
  {
    ...
    description: 'Give through mobile money, bank transfer or in person every Sunday',
    path: '/give/tithes-and-offering',
  },
  {
    icon: Quote,
    title: 'Testimony of Giving',
    description: 'Stories of God\'s faithfulness and the impact of generosity at LPC',
    path: '/give/testimony-of-giving',
  },
];

interface GiveDropdownProps {
  isOpen: boolean;
  onClose: () => void;
}

export function GiveDropdown({ isOpen, onClose }: GiveDropdownProps) {
